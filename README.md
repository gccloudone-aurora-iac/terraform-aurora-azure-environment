...
| <a name="input_data_sources"></a> [data\_sources](#input\_data\_sources) | n/a | <pre>object({<br>    dns_zone_id = object({<br>      cloud_aurora_ca = string<br>      azmk8s           = string<br>      blob_storage     = string<br>      keyvault         = string<br>    })<br>    active_directory = object({<br>      service_principal_id = object({<br>        gitlab_runner = string<br>      })<br>      tenant_id       = string<br>      subscription_id = string<br>    })<br>  })</pre> | n/a | yes |
