...
module "platform_infrastructure" {
  source = "git::https://github.com/gccloudone-aurora-iac/terraform-aurora-azure-environment-platform-infrastructure.git?ref=feat/velero-switch-to-workload-identity"
